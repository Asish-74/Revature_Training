...
# Shape of the array
print("Shape of array:", array.shape) # means 2 rows  3 columns
...
array_rand = np.random.rand(2, 3)   # only give between 0 to1
print("Random array with rand:\n", array_rand)

array_randn = np.random.randn(2, 3)
print("Random array with randn:\n", array_randn)  # it give negative value

array_randint = np.random.randint(0, 10, (2, 3))   # it print elements between 0 to 9
